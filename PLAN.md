...
| 2 | **Hangar v1 polish remainder** | ~1–2 hr | v1 shipped 2026-05-18: dedupe (`×N` pill) + swipe-to-delete with confirm landed. Still pending: illustrated-card stub for top type×airline combos (needs Planespotters or commissioned art) + rarity logic ("RARE" pill, magenta border) — both blocked on design calls. |
