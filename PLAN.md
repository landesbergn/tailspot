...
- **Outdoor/in-frame authenticity gate** — v1 bar or deferred? Decide alongside #3 (visual confirmation is its mechanism). Strategy elevates "a plane you actually saw, outdoors" (target problem + marketing key message), but the plan currently only gates grounded planes (#11).
