...
- That the app will be available at any particular time or continuously.
- That the flight data will be accurate or up to date.
- That your catch collection, score, or handle will be preserved indefinitely.
- That the app will work on every device or iOS version.
...
- **No impersonation.** Don't choose a name that impersonates another person, organization, or brand — real or fictional.
- **No offensive content.** Handles containing slurs, threats, or targeted harassment will be reset without warning.
- **No reserved terms.** We may reserve certain names (e.g., "Tailspot," "Admin") and deny or reset claims on them.
...
- Attempt to manipulate the catch-validation system by submitting false GPS coordinates, replayed positions, or any fabricated sensor data.
- Reverse-engineer, scrape, or bulk-download data from the Tailspot backend for any purpose outside normal app use.
...
The Tailspot app, its visual design, card art, and original content are owned by Noah Landesberg. Flight data displayed in the app comes from third-party sources (see the [Attributions](attributions.md)) and is subject to their respective licenses.
...
> REVIEW: "To the maximum extent permitted by law" is intentionally broad. A lawyer should confirm that this limitation is enforceable in the jurisdictions where you expect significant users (particularly the EU and UK, where liability limitations are more restricted than under California law).
...
> REVIEW: If you have meaningful EU/UK user volume, consider whether you need a separate dispute-resolution clause for those jurisdictions (e.g., a reference to the EU Online Dispute Resolution platform). California choice-of-law clauses are generally enforceable for US users but may not override mandatory local consumer-protection laws in the EU.
