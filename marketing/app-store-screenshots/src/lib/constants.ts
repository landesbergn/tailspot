...
export const THEMES: Record<string, Theme> = {
  ...
  "tailspot-dusk": {
    id: "tailspot-dusk",
    name: "Tailspot Dusk",
    bg: "#0A0E1A",      // Brand bgPrimary — the app is locked to dark
    bgAlt: "#00D4FF",   // brand cyan — the one inverted "pop" slide
    fg: "#E8F4FF",      // Brand textPrimary
    fgAlt: "#0A0E1A",   // dark type on the cyan slide
    accent: "#00D4FF",  // Brand cyan (HUD accent)
    muted: "#7F8B98",   // Brand textTertiary
    // The onboarding dusk-sky stops (same sky as the AR capture in shot 1),
    // so every slide lives in one continuous evening sky.
    bgGradient: "linear-gradient(180deg, #0A1226 0%, #17213D 62%, #3B3040 100%)",
    decor: "aviation",
  },
  "bloom-roast": {
    id: "bloom-roast",
