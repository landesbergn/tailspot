...
nonisolated enum CardSets {
    ...
    private static let familiesGapB: [CardSet] = [
        ...
        .init(id: "fam-piper", type: .ga, title: "Piper", entries: [
            ...
            .init(id: "fpa31", canonicalName: "Piper PA-31 Navajo", rarity: .common,
                  modelTokens: ["pa-31-300 navajo", "pa-31-310 navajo", "pa-31-325 navajo",
                                "pa-31-350 chieftain", "pressurized navajo"],
                  summary: "Cabin-class piston twin — Navajo through Chieftain.",
                  representativeTypecode: "PA31"),
            .init(id: "fpa60", canonicalName: "Piper PA-60 Aerostar", rarity: .common,
                  modelTokens: ["aerostar 600", "aerostar 601", "pa-60 aerostar"],
                  summary: "High-performance piston twin, later produced as the Piper PA-60.",
                  representativeTypecode: "AEST"),
        ...
        .init(id: "fam-heli", type: .ga, title: "Helicopters", entries: [
            ...
            .init(id: "fh-a119", canonicalName: "Leonardo AW119", rarity: .uncommon,
        ...
        .init(id: "fam-falcon", type: .biz, title: "Dassault Falcon", entries: [
            .init(id: "ffa20", canonicalName: "Falcon 20", rarity: .uncommon,
                  modelTokens: ["mystère 20", "mystere 20", "fan jet falcon"],
                  summary: "The original Falcon business jet, also known as the Mystère 20.",
                  representativeTypecode: "FA20"),
    ...
    private static let familiesGapC: [CardSet] = [
        ...
        .init(id: "fam-sport-classics", type: .ga, title: "Sport & classics", entries: [
            ...
            .init(id: "fsc-citabria", canonicalName: "Citabria Adventure", rarity: .common,
                  modelTokens: ["7gcaa", "citabria adventure"],
                  summary: "Tandem-seat taildragger built for training and light aerobatics.",
                  representativeTypecode: "CH7B"),
            .init(id: "fsc-gamebird", canonicalName: "GB-1 GameBird", rarity: .common,
                  modelTokens: ["gb-1 gamebird", "game composites gamebird"],
                  summary: "Carbon-composite two-seat aerobatic aircraft with cross-country range.",
                  representativeTypecode: "GB1"),
            .init(id: "fsc-mx2", canonicalName: "MX2", rarity: .common,
                  modelTokens: ["mx aircraft mx-2"],
                  summary: "Carbon-composite two-seat aerobatic and cross-country sport aircraft.",
                  representativeTypecode: "MX2"),
            .init(id: "fsc-sling4", canonicalName: "Sling 4", rarity: .common,
                  modelTokens: ["sling 4"], summary: "Four-seat South African sport tourer.",
                  representativeTypecode: "SLG4"),
