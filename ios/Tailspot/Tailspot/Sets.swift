...
nonisolated enum CardSets {
    ...
    private static let familiesGapA: [CardSet] = [
        ...
        .init(id: "fam-dornier-328", type: .regional, title: "Dornier 328JET", entries: [
            .init(id: "fd328-jet", canonicalName: "Dornier 328JET", rarity: .common,
                  modelTokens: ["dornier 328jet", "328jet"],
    ...
    private static let familiesGapB: [CardSet] = [
        .init(id: "fam-cessna", type: .ga, title: "Cessna", entries: [
            ...
            .init(id: "fc337", canonicalName: "Cessna 337 Skymaster", rarity: .common,
                  modelTokens: ["cessna 337", "super skymaster"],
                  summary: "Push-pull twin with one engine at each end.",
                  representativeTypecode: "C337"),
        ]),
    ...
    private static let familiesGapC: [CardSet] = [
        ...
        .init(id: "fam-vintage", type: .heritage, title: "Vintage & warbirds", entries: [
            ...
            .init(id: "fv-navion", canonicalName: "North American Navion", rarity: .common,
                  modelTokens: ["l-17 navion", "navion"],
                  summary: "Postwar four-seat design also flown by the U.S. military.",
                  representativeTypecode: "NAVI"),
        ...
        .init(id: "fam-sport-classics", type: .ga, title: "Sport & classics", entries: [
            ...
            .init(id: "fsc-cruz", canonicalName: "CSA PiperSport / SportCruiser", rarity: .common,
                  modelTokens: ["csa pipersport", "csa sportcruiser", "pipersport", "sportcruiser"],
                  summary: "Czech low-wing light sport tourer and trainer.",
                  representativeTypecode: "CRUZ"),
            .init(id: "fsc-sling2", canonicalName: "Sling 2 / Sonaca 200", rarity: .common,
                  modelTokens: ["sling 2", "sonaca s-2", "sonaca 200"],
                  summary: "Two-seat all-metal sport aircraft and certified trainer.",
                  representativeTypecode: "SLG2"),
            ...
            .init(id: "fsc-sonex", canonicalName: "Sonex", rarity: .common,
                  modelTokens: ["sonex"], summary: "Compact metal homebuilt sport aircraft.",
