...
/// parametric position every frame. (Lived in OnboardingFlow.swift
/// while onboarding had a calibration step; this sheet is the only
/// consumer since that step's removal, 2026-08-13.)
