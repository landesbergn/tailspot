...
//  the 737 MAX is COMMON (newest 737, but ~1,500+ fly daily), and the
//  Phenom 300 / workhorse widebodies are UNCOMMON.
//
...
struct RarityResolutionTests {
    ...
    @Test(arguments: [
        ...
        ("A333", .uncommon),         // A330-300 — workhorse widebody
        ("B763", .uncommon),         // 767-300 — workhorse widebody
        ("B789", .uncommon),         // 787-9 — workhorse widebody
        ...
        ("A388", .epic),             // A380-800 — super-heavy
